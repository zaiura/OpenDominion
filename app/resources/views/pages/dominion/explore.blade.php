        ...
        <div class="col-sm-12 col-md-3">
            ...
            <div class="box">
                ...
                <div class="box-body">
                    ...
                    <p>You can afford to explore for <b>{{ number_format($explorationCalculator->getMaxAfford($selectedDominion)) }} {{ str_plural('acre', $explorationCalculator->getMaxAfford($selectedDominion)) }} of barren land</b>.</p>
                </div>
            </div>
        </div>
